...
struct Announcement {
    ...
    // Default constructor
    Announcement() : next_hop_asn(0), received_from_relationship(Relationship::ORIGIN) {}

    // Parameterized constructor for convenience
    Announcement(const std::string& _prefix, const std::vector<uint32_t>& _as_path, uint32_t _next_hop_asn, Relationship _rel)
        : prefix(_prefix), as_path(_as_path), next_hop_asn(_next_hop_asn), received_from_relationship(_rel) {}
